@ECHO OFF
@REM File: any-object-sys-library_subscriber\pre-build.bat
@REM Version: 0.1.1
@REM Date: 13-May 2015
@REM Author: Alex Russell
@REM Comment [0.1.1] Added :REGEXP

TYPE ..\source\any-object-sys-library\template%_ENVN_%%_INST_%.properties|perl envvar.pl > .env1.bat
CALL .env1.bat & ERASE /q .env1.bat
ECHO %1|perl envvar.pl > .env2.bat
CALL .env2.bat & ERASE /q .env2.bat
CALL :CLONE any-object-sys-library_subscriber
...
CALL :REGEXP _subscriber.subflow
CALL :REGEXP _subscriber.esql

...
class AWTransactionSubscriberTransactionDiscountScenarios {
    ...
    static {
        ...
        /* 0 */
         specList << new InputBean(
                 ...
                 sourceXpaths: ['//Messages/POSLog/Transaction/RetailTransaction/LineItem/Discount/ReasonCode':'COUPON SUBTOTAL DISCOUNT'],
        ...
        specList << new InputBean(
                ...
                sourceXpaths: ['//Messages/POSLog/Transaction/RetailTransaction/LineItem/Discount/ReasonCode':'PRICE MATCHING SUBTOTAL DISCOUNT'],
        ...
        specList << new InputBean(
                ...
                sourceXpaths: ['//Messages/POSLog/Transaction/RetailTransaction/LineItem/Discount/ReasonCode':'TEAM SUBTOTAL DISCOUNT'],
        ...
        specList << new InputBean(
                ...
                sourceXpaths: ['//Messages/POSLog/Transaction/RetailTransaction/LineItem/Discount/ReasonCode':'INCORRECT TICKET SUBTOTAL DISCOUNT'],
        ...
        specList << new InputBean(
                ...
                sourceXpaths: ['//Messages/POSLog/Transaction/RetailTransaction/LineItem/Discount/ReasonCode':'GST EVENT SUBTOTAL DISCOUNT'],
        ...
        specList << new InputBean(
                ...
                sourceXpaths: ['//Messages/POSLog/Transaction/RetailTransaction/LineItem/Discount/ReasonCode':'MANAGER OVERRIDE SUBTOTAL DISCOUNT'],
        ...
        specList << new InputBean(
                ...
                sourceXpaths: ['//Messages/POSLog/Transaction/RetailTransaction/LineItem/Discount/ReasonCode':'EMPLOYEE SUBTOTAL DISCOUNT'],
...
//        specList << new InputBean(
//                jiraID: 'FPOE-12512',
//                description: "Tests discount code translation for MULTIPLE PRICE OVERRIDE",
//                sourceXpaths: ['//Messages/POSLog/Transaction/RetailTransaction/LineItem/Sale/RetailPriceModifier/ReasonCode':'MULTIPLE PRICE OVERRIDE'],
//                targetXpaths: ['//Line[2]/LineObject':'477']
//        )
//
//        /* 18 */
//        specList << new InputBean(
